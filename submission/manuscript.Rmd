...
Similarly, when examining community structure between sites and sides, there is no clear pattern among individuals. Microbial communities do not separate on an ordination by the left or right sides in either the mucosal or lumenal samples (Figure 2C). 
