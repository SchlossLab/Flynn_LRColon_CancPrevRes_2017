...
1.39.5 (15). \(\theta\)\textsubscript{YC} distances were calculated to
...
leave-one-subject out approach (17). For each model the data was split
...
Characteristic curves using the pROC R package (18). Resultant models
