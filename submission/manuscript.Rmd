...
To get around the noisiness created by a diverse set of samples, we employed machine learning algorithms to identify microbes specific to each side. 
...
- note that we have FIT for all of these people but they're all below limit of detection (except for 2). when we look at models for CRC, cant predict R vs L, so create models for healthy
