...
- do the populations of bacteria in the left and right colon contribute to the development of specific subtypes of CRC? (central Q)
...
- first, need to characterize healthy species that are specific to each location. then we can ask, if/how disruption affects tumorigenesis? (data needed to answer Q)
- mucosal vs lumenal populations studies have also been complicated by bowel prep (what methods are used to get data? what analysis must be applied?- ML)
...
- what data were obtained? what were the results of the analyses?
